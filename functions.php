...
function theme_styles() {
	wp_enqueue_style( 'theme_font', 'https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@400;700&family=Open+Sans:wght@400;700&display=swap', array(), '1.0.0' );
	wp_enqueue_style( 'theme_reset', get_template_directory_uri() . '/css/normalize.css', array( 'theme_font' ), '1.0.0' );
	wp_enqueue_style( 'theme_style', get_template_directory_uri() . '/css/flex.css', array( 'theme_reset' ), '1.0.0' );
}
